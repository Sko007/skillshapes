...
import { getEntity, updateEntity, createEntity, reset } from 'app/entities/skill-shape/skill-shape.reducer';
import { ISkillShape } from 'app/shared/model/skill-shape.model';
import { convertDateTimeFromServer, convertDateTimeToServer, displayDefaultDateTime } from 'app/shared/util/date-utils';
import { mapIdList } from 'app/shared/util/entity-utils';

import { ISkillShapeUpdateProps } from 'app/entities/skill-shape/skill-shape-update';

export const SkillShapeDashboardUpdate = (props: ISkillShapeUpdateProps) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(SkillShapeDashboardUpdate);
